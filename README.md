...
农院路按约 **2.17 千米公共道路**单独建模，保留与两侧校园的隔离关系；崇左桥、博萃桥、荟贤桥呈现农院路上跨、校道下穿的结构，并提供桥下近景。近景包含围栏、路缘、盲道、路灯、坡道、挡墙、桥梁护栏和排水盖板。详细依据和照片覆盖范围见[农院路与桥梁研究及建模记录](docs/INFRASTRUCTURE.md)。
