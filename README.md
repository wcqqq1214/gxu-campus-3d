...
| 功能 | 可以做什么 |
| --- | --- |
| **地标探索** | 按分类与“六教”“新东园门”等别名搜索，定位 18 处精选地标。 |
...
精选地标涵盖南大门、图书馆、汇学堂、大礼堂、综合体育馆、大学生活动中心、第六教学楼、第二教学楼、综合实验大楼、计算机与电子信息学院、留学生公寓、新东门、东门、西门，以及崇左桥、博萃桥、荟贤桥及图书馆北侧的时光之门。普通建筑与七座无可靠名称资料的湖上桥梁参与场景展示，不进入搜索与巡游名单。
...
- [模型资源](public/models/)：校园基础模型、30 个普通建筑区块、16 个道路与跨水桥近景区块、18 处独立地标和树木模板。
