...
2026-09-20 补充：门廊两侧主体正面新增各五道水平挑檐，原门廊、主体、窗列及端部待核实范围保留，见[正面挑檐专项](AGRICULTURE_FACADE_LEDGES.md)。此为正面局部推进，仍不计作整栋验收完成。

2026-09-20 后续：南立面东侧主墙顶层由9扇统一通用窗改为15扇显式窗，其中5扇较矮。配置方向已按原边东→西转换，尺寸与间距仍为估算；门廊及挑檐保持，见[顶层窗列专项](AGRICULTURE_TOP_WINDOWS.md)。底部四层和中央特殊檐口仍待核对。
