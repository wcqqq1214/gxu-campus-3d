...
**当前状态（2026-09-21）：[首轮整栋校准通过](CIVIL_WHOLE_REVIEW.md)。** 四项核对、23组几何检查、整栋画面及同资产性能核验已汇总，估算和未知项单列保留。后续进入实验大厅、新结构大楼。以下为各批次历史记录，“未整栋完成”表示该批次当时状态。

2026-09-21接续：[主楼北向内院外廊](CIVIL_NORTH_GALLERY.md)补入七层退进空间、重复折线楼板与白色实栏，以及后墙开口。仅覆盖原内环第3边；两端楼梯间、北翼外廊与其他待核对部位继续保留，未计为整栋完成。

2026-09-21接续：[北翼体量专项](CIVIL_REAR_MASSING.md)依据[北侧航拍](CIVIL_REAR_MASSING_EVIDENCE.md)拆分南主楼、东/西连接段及北翼，采用估算的10.8米北翼檐口、13.1米连续坡屋脊，以及10.8/13.2米连接段，保留南主楼26.4米及原轮廓、内院。连接段层数、全部高度和屋脊位置仍非测绘确认，侧后立面继续待细化。官方2024年施工位置图把旧结构大厅线索定位到学院楼北侧施工范围内，不能据此认定拆除完成。

此前[后翼与实验建筑时点核对](CIVIL_SITE_EVIDENCE.md)补入2022年拆除采购及中标公告；其后[第七层退进与西端延续墙](CIVIL_SEVENTH_RECESS.md)已验收。用户所指大厅仍需与新平台内现用大厅区分，建模顺序保持。
...
第七层随后落实[南立面及西端延续墙的退进窗面](CIVIL_SEVENTH_RECESS.md)，第八层深隔板保持原层位；退进深度和薄底板尺寸仍为估算。209项Python、56项Node测试及模型、画面和同条件性能联合验收通过；第七层待办由本批接续完成，后翼、其他立面、未确认屋面及完整前庭继续核对。
...
| --- | --- | --- |
| 实验大厅 | 同时核对“旧结构试验大厅”与新平台内部实验大厅；尚未锁定模型ID | 旧大厅现状、轮廓、是否包含在相邻复合对象中，与新平台南楼实验大厅区分 |
...
2026-09-21补充：[2024年临时水电施工图已成功取得](CIVIL_UTILITY_PLAN_EVIDENCE.md)，为平台低体量和邻接实验室补充平面与层数线索。学院旧楼区域的“拟拆除”标签只证明当时意向；各分部仍需与模型配准，不据此改层数或删除楼栋。后续大厅与新结构大楼的实施范围、依赖和顺序统一见该记录。
